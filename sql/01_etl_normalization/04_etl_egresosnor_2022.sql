...
-- SCRIPT: 04_etl_egresosnor_2022.sql
-- DESCRIPCIÓN: Creación y normalización de la tabla de egresos hospitalarios 2022 en BigQuery.
-- ======================================================================================
...
SELECT
    ...
    -- 2. Extracción del código CIE-10 puro sin espacios ni descripción
...
FROM `airy-runway-450418-q9.warehouse.egresos_2022`
WHERE
