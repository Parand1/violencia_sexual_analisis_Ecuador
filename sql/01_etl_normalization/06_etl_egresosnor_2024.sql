...
-- SCRIPT: 06_etl_egresosnor_2024.sql
-- DESCRIPCIÓN: Creación y normalización de la tabla de egresos hospitalarios 2024 en BigQuery.
-- ======================================================================================
...
FROM `airy-runway-450418-q9.warehouse.egresos`
WHERE
