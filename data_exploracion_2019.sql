--CREACION DE TABLA DE EGRESOS NORMALIZADA 2019
...
--EXPLORACION DE CIE 10 RELACIONADOS CON VIOLENCIA 2019
SELECT
DISTINCT(cie10_codigo)
FROM
warehouse.egresosnor_2019
WHERE
...
-- ENFOQUE SOLO EN CIE 10 T742 POR PROVINCIA 2019
SELECT
prov_res,
COUNT(*) AS numero_de_casos,
ROUND(AVG(dias_estancia), 2) AS estancia_promedio,
...
--TOP 3 PROVINCIAS - EXPLORACION DE DATOS 2019
...
warehouse.egresosnor_2019
WHERE
cie10_codigo = 'T742' AND prov_res IN ('Azuay', 'Morona Santiago', 'Tungurahua')
GROUP BY
grupo_edad,
sexo,
prov_res
